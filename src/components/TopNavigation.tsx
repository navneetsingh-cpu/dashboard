...
export function TopNavigation({ theme, setTheme, sidebarOpen, setSidebarOpen }: TopNavigationProps) {
  return (
      ...
      <div className="h-full px-4 flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="font-semibold text-gray-900 dark:text-white">Analytics Pro</span>
          </div>
        </div>
